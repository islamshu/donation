...
<body>
    ...
    <!-- #Top Bar -->
    <?php echo $__env->make('admin.partials.side', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/ecommerce/product-detail.js')); ?>"></script>
...
channel.bind('App\\Events\\NewUser', function (data) {
    ...
    var newNotificationHtml = `<a href="`+data.url+`"><span class="table-img msg-user">
                                            <img src="`+ `<?php echo e(asset('uploads/user/deflut.png')); ?>` + `" alt="">
...
</body><?php /**PATH D:\prize\resources\views/layouts/admin.blade.php ENDPATH**/ ?>