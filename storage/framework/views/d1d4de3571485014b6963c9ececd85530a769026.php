...
<!-- Mirrored from dahersaleh.com/index.php?lang=en by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 May 2022 20:53:18 GMT -->
<!-- Added by HTTrack -->
...
<head>
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="keywords"
        content="charity assalam, daher saleh, благотворительный фонд ассалам, дагер салех مؤسسة خيرية &quot;السلام&quot;, رئيس الجمعية صالح محمد ظاهر" />
    <meta name="author" content="noadmin" />
    <meta property="og:title" content="Charity &amp;quot;Assalam&amp;quot;" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="index9ed2.html?lang=en" />
    <meta property="og:site_name" content="Charity &quot;Assalam&quot;" />
    <meta name="description" content="Благотворительный фонд &quot;Ассалам&quot; " />
    <meta name="generator" content="Joomla! - Open Source Content Management" />
    <title><?php echo e(App\General::first()->name_en); ?></title>
    <link rel="icon" href="<?php echo e(asset('uploads/' . App\General::first()->logo)); ?>" type="image/x-icon">

    <link href="favicon.ico" rel="shortcut icon" type="<?php echo e(asset('uploads/' . App\General::first()->logo)); ?>" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/menu.gkmenu.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/reset/meyer.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/layout.css" type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/joomla.css" type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/template.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/menu.css" type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/gk.stuff.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/k2.css" type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/typography.style1.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/typography.iconset.1.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/typography.iconset.2.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/typography.iconset.3.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/templates/gk_black_and_white/css/style1.css" type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/modules/mod_news_pro_gk4/interface/css/style.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/modules/mod_image_show_gk4/styles/gk_black_and_white/style.css"
        type="text/css" />
    <link rel="stylesheet" href="https://dahersaleh.com/media/mod_languages/css/template.css" type="text/css" />
    ...
    <script src="https://dahersaleh.com/media/system/js/mootools-more.js" type="text/javascript"></script>
    <script src="https://dahersaleh.com/templates/gk_black_and_white/js/menu.gkmenu.js" type="text/javascript"></script>
    <script src="https://dahersaleh.com/templates/gk_black_and_white/js/gk.scripts.js" type="text/javascript"></script>
    <script src="../connect.facebook.net/en_US/all.js#xfbml=1" type="text/javascript"></script>
    <script src="../platform.twitter.com/widgets.js" type="text/javascript"></script>
    <script src="https://dahersaleh.com/modules/mod_news_pro_gk4/interface/scripts/engine.js" type="text/javascript">
    </script>
...
<body>
    ...
    <?php if(auth()->guard()->guest()): ?>
        <div id="ModalLoginForm" class="modal fade">
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="background-color: #153c40;height: 885px;">
                    <div class="modal-header">
                        <h1 class="modal-title"><?php echo e(__('Login')); ?></h1>
                    </div>
                    <div id="errors-list"></div>

                    <div class="modal-body">
                        <form role="form" id="handleAjax" method="POST" action="<?php echo e(route('doLogin')); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <br>
                        <h1 style="text-align: center"><?php echo e(__('Register')); ?></h1>
                        <div id="errors-listre"></div>

                        <form role="form" method="POST" id="handleAjaxre" action="<?php echo e(route('doRegister')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
    ...
    <div id="gkPageTop" class="gkMain gkWrap clear">
        ...
        <h1 id="gkLogo" class="testtt">
            <a href="/">
                <img src="<?php echo e(asset('uploads/' . App\General::first()->logo)); ?>" width="200" height="130"
                    alt="<?php echo e(App\General::first()->name_en); ?> " Assalam "" />
            </a>
        ...
        <div id="assalam">
            ...
            <div class="custom">
                <p><img src="<?php echo e(asset('uploads/' . App\General::first()->big_logo)); ?>" alt="logo en"
                        style="margin-top: 40px;" height="161" width="477" />
                </p>
            </div>
            ...
            <div id="portret">
                ...
                <div class="custom">
                    <p style="margin-top: 10px; text-align: center; font-size: 16px; line-height: 18px; color: black;display: inline-block">
                        <br /><br /><br /><br /><br /><br /><br /><br /><br />
                        <?php if(auth()->guard()->check()): ?>
                            <?php echo e(auth()->user()->name); ?>

                            <form style="display: inline-flex" action="<?php echo e(route('logout')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                            <input type="submit" value="<?php echo app('translator')->get('logout'); ?>">                                
                            </form>
                        <?php endif; ?>
        ...
        <div id="wrapperContent" class="gkWrap">
            <div id="wrapperContent2">
                ...
                <div id="gkHeader" class="gkMain">
                    ...
                    <div class="box">
                        <div class="content">
                            <div id="gkIs-gk-is-156" class="gkIsWrapper-gk_black_and_white">

                                <div class="gkIsPreloader"><?php echo app('translator')->get('Loading'); ?></div>

                                <div class="gkIsSlides" style="width: 950px;height: 350px;">

                                    <?php $__currentLoopData = App\Slider::get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="gkIsSlide"><?php echo e(asset('uploads/' . $item->image)); ?></span>
                        ...
                        <div id="gkLeft" class="gkMain gkCol gkPaddingTBLR">
                            ...
                            <div id="gkLeftMiddle" class="gkMain oneCol gkPaddingTBL">
                                <div id="gkLeftLeft" class="gkMain gkCol gkPaddingTBL">
                                    <div class="box">
                                        <h3 class="header" style="color: rgb(255, 255, 255) !important">
                                            <span><?php echo app('translator')->get('Menu'); ?></span>
                                        </h3>
                                        <div class="content">
                                            <ul class="menu">
                                                <li class="item-234 current active"><a style="color: #000 !important"
                                                        href="/"><?php echo app('translator')->get('home'); ?></a></li>
                                                <li class="item-233"><a style="color: #000 !important"
                                                        href="/about_us"><?php echo app('translator')->get('About us'); ?></a></li>
                                                <li class="item-252"><a style="color: #000 !important"
                                                        href="/news"><?php echo app('translator')->get('News'); ?></a>
                                                </li>
                                                <li class="item-253"><a style="color: #000 !important"
                                                        href="/gallery"><?php echo app('translator')->get('Gallery'); ?></a>
                                                </li>

                                                <li class="item-254"><a style="color: #000 !important"
                                                        href="/contact"><?php echo app('translator')->get('Contact us'); ?></a></li>
                                                <li class="item-255"><a style="color: #000 !important"
                                                    data-toggle="modal" <?php if(auth()->guard()->guest()): ?> data-target="#ModalLoginForm" <?php else: ?>
                                                    ...
                                                    <?php else: ?>
                                                     ...
                                                     data-target="#myModal" 
                                                     <?php endif; ?>
                                                      <?php endif; ?>><?php echo app('translator')->get('Make a donation'); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div id="myModalnotvalid" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p style="color: black"><?php echo app('translator')->get('Your Account  in progress'); ?></p>
                            </div>
                    ...
                    <div id="gkRight" class="gkMain gkCol gkPaddingTBLR">
                        ...
                        <div id="gkRightMiddle" class="gkMain oneCol gkPaddingTBLR">
                            ...
                            <div id="gkRightRight" class="gkMain gkCol gkPaddingTBLR">
                                ...
                                <div class="box">
                                    <h3 class="header"><?php echo app('translator')->get('last news'); ?></h3>
                                    <div class="content">
                                        <div class="nspMain nspFs100" id="nsp-nsp_131" style="width:100%;">
                                            ...
                                            <div class="nspLinksWrap bottom " style="width:99.9%; ">
                                                <div class="nspLinks " style="margin:0; ">
                                                    <ul class="nspList ">
                                                        <?php $__currentLoopData = App\News::get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li
                                                                class="<?php if($key % 2 == 0): ?> even <?php else: ?> odd <?php endif; ?>">
                                                                <h4>
                                                                    <a style="color: black"
                                                                        href="<?php echo e(route('single_new', $item->id)); ?>"
                                                                        title="<?php echo e($item->title); ?>"><?php echo e($item->title); ?></a>
                                                                </h4>
                                                                <span class="colornew"
                                                                    style="color: black"><?php echo $item->body; ?>
                                                    ...
                                                    <div class="nspBotInterface">
                                                        <div>
                                                            ...
                                                            <span
                                                                class="nspCounter"><strong>Page:</strong><span></span></span>
                                                        </div>
                                                    </div>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="height: 250px;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black"><?php echo app('translator')->get('Donation Detals'); ?></h4>
            </div>
            <div class="modal-body">
                <p style="color: black"><?php echo app('translator')->get('Amount to be donated'); ?></p>
                <form action="<?php echo e(route('stripe.get')); ?>" method="get">
                    <div class="form-group">
                        <input type="number" class="form-control" id="exampleInputEmail1" name="amount"
                            aria-describedby="emailHelp" placeholder="<?php echo e(__('amount')); ?>">
                    </div>

                    <button type="submit" style="height: 40px !important;"
                        class="btn btn-primary"><?php echo app('translator')->get('Submit'); ?></button>
                </form>
...
<div id="bottomWrap" class="gkWrap">
    <center>
        ...
        <footer class="Copy__footer">
            ...
            <figure class="PaymentLogoGrid " style="    background: white;">
                <svg xmlns="http://www.w3.org/2000/svg" width="42" height="24" viewBox="0 0 42 24"
                    class="PaymentLogo variant-- ">
                    <title>Visa</title>
                    <path fill="var(--paymentLogoColor, #1434cb)"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="85" height="16" viewBox="0 0 85 16"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <g stroke="#427FBC" stroke-linecap="square">
                            <path stroke-opacity=".1" d="M1003.5-6508V7929" fill="var(--paymentLogoColor, null)">
                            </path>
                            <path stroke-opacity=".15" stroke-dasharray="3,5"
                                d="M733.5-6508V7929M463.5-6508V7929M193.5-6508V7929"
                                fill="var(--paymentLogoColor, null)"></path>
                            <path stroke-opacity=".1" d="M-76.5-6508V7929" fill="var(--paymentLogoColor, null)">
                            </path>
                        </g>
                        <g fill-rule="nonzero">
                            <path
                                ...
                                fill="var(--paymentLogoColor, #0A2540)"></path>
                            <path
                                ...
                                fill="var(--paymentLogoColor, #ED0006)"></path>
                            <path
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="24" viewBox="0 0 50 24"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <path fill="var(--paymentLogoColor, #017ECD)" fill-rule="nonzero"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="24" viewBox="0 0 26 24"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <g fill-rule="nonzero">
                            <path fill="var(--paymentLogoColor, #2283CB)"
                                d="M14.62 22.98H10.7A10.9 10.9 0 0 1 0 12.08C-.18 6.16 4.4 1.2 10.24 1h4.4A11.09 11.09 0 0 1 25.8 12v.1a11.2 11.2 0 0 1-11.18 10.89z">
                            </path>
                            <path fill="var(--paymentLogoColor, #FFF)"
                                d="M11 2.91A9.13 9.13 0 0 0 1.91 12c0 4.97 4.1 9.07 9.07 9.07 4.97 0 9.08-4.1 9.08-9.07 0-4.97-4.11-9.08-9.08-9.08z">
                            </path>
                            <path fill="var(--paymentLogoColor, #2283CB)"
                                d="M12.42 18.1V5.97a6.24 6.24 0 0 1 0 12.13zm-2.86 0a6.28 6.28 0 0 1 0-12.13V18.1z">
                            </path>
                        </g>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="55" height="24" viewBox="0 0 55 24"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <path fill="var(--paymentLogoColor, #0A2540)" fill-rule="nonzero"
                            d="M16.78 11.7c0-2.6 2-4.7 4.6-4.5.7 0 1.5.1 2.1.5v2c-.5-.6-1.3-1-2.1-1-1.6.1-2.9 1.5-2.8 3.1v.2c0 1.6 1.3 2.8 2.9 2.8.8 0 1.5-.4 2-1v2c-.7.3-1.4.5-2.2.5-2.5 0-4.5-2.1-4.5-4.6zm17.98-4.5l2.3 6 2.4-6h1.8l-3.7 9.1h-.9l-3.7-9.1h1.8zM13.22 7h.17c.9 0 1.8.4 2.5 1l-.9 1.2c-.4-.4-.9-.7-1.4-.7-.6-.1-1.1.4-1.2 1 0 .5.3.7 1.3 1.1 2 .8 2.5 1.4 2.6 2.6v.3c-.1 1.6-1.4 2.8-3 2.7-1.2 0-2.4-.6-3-1.7l1.1-1.1c.3.7 1 1.2 1.8 1.2h.1c.6 0 1.2-.6 1.2-1.3 0-.4-.2-.7-.5-.9-.4-.2-.8-.4-1.2-.5-1.6-.5-2.1-1.2-2.1-2.4v-.1c.1-1.4 1.3-2.5 2.7-2.4zM3 7.2c2.4.1 4.3 2.1 4.2 4.5 0 1.3-.6 2.5-1.6 3.4-.9.7-2 1.1-3.1 1H0V7.2zm6.59 0v8.9h-1.7V7.2h1.7zm37.26 0v1.5h-3.1v2h3v1.5h-3v2.4h3.1v1.5h-4.8V7.2h4.8zm3.6 0c2 0 3.09.9 3.09 2.6.1 1.3-.8 2.4-2 2.6l2.7 3.7h-2.1l-2.3-3.6h-.2v3.6h-1.7V7.2zM4.48 9.4c-.6-.5-1.5-.8-2.3-.7h-.5v5.9h.5c.8.1 1.7-.2 2.3-.7.6-.6.9-1.4.9-2.3 0-.8-.3-1.6-.9-2.2zm45.65-.8h-.5v2.7h.5c1.1 0 1.6-.5 1.6-1.4 0-.8-.5-1.3-1.6-1.3z">
                        </path>
                        <path fill="var(--paymentLogoColor, #FFA201)" fill-rule="nonzero"
                            d="M28.67 7.1c-2.5 0-4.6 2-4.6 4.6 0 2.5 2 4.6 4.6 4.7 2.6.1 4.6-2 4.7-4.6-.1-2.6-2.1-4.7-4.7-4.7z">
                        </path>
                        <path d="M0 0h55v24H0z" fill="var(--paymentLogoColor, null)"></path>
                    </g>
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <g fill-rule="nonzero">
                            <path fill="var(--paymentLogoColor, #1B6BAF)"
                            ...
                            <path fill="var(--paymentLogoColor, #D02644)"
                            ...
                            <path fill="var(--paymentLogoColor, #46A548)"
...
<?php /**PATH D:\prize\resources\views/layouts/fronts.blade.php ENDPATH**/ ?>