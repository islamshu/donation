                        ...
                        <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <form class="form-horizontal" method="post" action="<?php echo e(route('admin.update')); ?>">
                                        <?php echo csrf_field(); ?> 
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="text" value="<?php echo e($admin->name); ?>" name="name" id="name" class="form-control"
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="email" value="<?php echo e($admin->email); ?>" name="email" id="email_address_2" class="form-control"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prize\resources\views/admin/profile.blade.php ENDPATH**/ ?>