    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-8">
                <div class="card">
                    <div class="header">
                        <h2 style="display: inline"><?php echo app('translator')->get('About'); ?> </h2>
                                ...
                                <div class="card">
                                    ...
                                    <div class="body">
                                        ...
                                        <form class="form-horizontal" method="post"
                                            action="<?php echo e(route('about.store')); ?>"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?> 
                                            <div class="row clearfix">
                                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                    <label for="email_address_2"> <?php echo app('translator')->get('Contect'); ?>  <span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prize\resources\views/admin/about.blade.php ENDPATH**/ ?>