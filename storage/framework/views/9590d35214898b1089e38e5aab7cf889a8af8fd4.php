    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item active"><?php echo app('translator')->get('Edit Gallery'); ?></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-8">
                <div class="card">
                    <div class="header">
                        <h2 style="display: inline"><?php echo app('translator')->get('Edit Gallery'); ?></h2>
                            ...
                            <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        ...
                                        <?php endif; ?>
                                        <form class="form-horizontal" method="post" action="<?php echo e(route('gallery.update',$gal->id)); ?>"
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input required type="text" value="<?php echo e($gal->title); ?>"
                                            ...
                                            <div class="row clearfix testt ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" name="test[]" readonly value="<?php echo e($item); ?>" id="images"
                                                                class="form-control">
                                                        </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-8 col-xs-7">
                                                    <img src="<?php echo e(asset('uploads/'.$item)); ?>" width="70" height="50" alt="">
                                                ...
                                                <div class="col-lg-1 col-md-1 col-sm-8 col-xs-7">
                                                    <a href="javascript:void(0);" class="remove_buttonn"
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var tests = $('.testt'); //Input field wrapper
                ...
                $(tests).on('click', '.remove_buttonn', function(e) {
                    e.preventDefault();
                    $(this).parent().parent('div').remove(); //Remove field html
                    x--;
                });
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\prize\resources\views/admin/gallary/edit.blade.php ENDPATH**/ ?>