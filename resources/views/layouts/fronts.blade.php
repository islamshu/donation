    ...
    <div class="bg">
        ...
        <div id="gkPageTop" class="gkMain gkWrap clear">
            ...
            <div id="assalam">
                ...
                <div class="custom">
                    <p><img src="{{ asset('uploads/'.App\General::first()->big_logo) }}" alt="logo en" style="margin-top: 40px;" height="161" width="477" />
                    </p>
                </div>
                ...
                <div id="portret">
                    ...
                    <div class="custom">
                        <p style="margin-top: 10px; text-align: center; font-size: 16px; line-height: 18px; color: black;"><br /><br /><br /><br /><br /><br /><br /><br /><br />@lang('President')<br /><strong>{{ App\General::first()->President }}</strong></p>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="custom">
                                                ...
                                                <a data-toggle="modal" data-target="#myModal"
                                                    target="_blank" href=""><img src="https://feedingthevalley.org/wp-content/uploads/2020/11/57935f84ba_Click-Here-to-Donate.png"
    ...
    <div class="modal fade" id="myModal" role="dialog">
            ...
            <div class="modal-body">
              <p style="color: black">@lang('Amount to be donated')</p>
                <form action="{{ route('stripe.get') }}" method="get">
                    ...
                    <button type="submit" style="height: 40px !important;" class="btn btn-primary">@lang('Submit')</button>
                  </form>
      ...
      <div id="bottomWrap" class="gkWrap">
        ...
        <div style="text-align:center !important;">
            <a title="Создание сайтов" style="text-decoration:none" href="wa.me/00970592722789" target="_blank">Designed by Eng: Islam Moh Shublaq</a></div>
    </div>
