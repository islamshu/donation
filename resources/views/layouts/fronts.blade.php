...
<head>
    ...
    <link href="favicon.ico" rel="shortcut icon" type="{{ asset('uploads/' . App\General::first()->logo) }}" />
    ...
    <style type="text/css">
        body {
            ...
            /* https://j.gifs.com/KrWgwQ.gif */
            /* https://i.pinimg.com/originals/5d/a7/d7/5da7d7ae5bf9ea9dc59d83b3fc5cc838.jpg */
            background: #fff url(https://i.gifer.com/7ZlE.gif) center top no-repeat !important;
...
<body>
    ...
    <div id="gkPageTop" class="gkMain gkWrap clear">
        ...
        <h1 id="gkLogo" class="testtt">
            <a href="/">
                <img src="{{ asset('uploads/' . App\General::first()->logo) }}" width="200" height="130"
                    alt="{{ App\General::first()->name_en }} " Assalam "" />
            </a>
        ...
        <div id="assalam">
            ...
            <div class="custom">
                <p><img src="{{ asset('uploads/' . App\General::first()->big_logo) }}" alt="logo en"
            ...
            <div id="portret">
                ...
                <div class="custom">
                    <p style="margin-top: 10px; text-align: center; font-size: 16px; line-height: 18px; color: black;display: inline-block">
                        ...
                        @auth
                            {{ auth()->user()->name }}
                            <form style="display: inline-flex" action="{{ route('logout') }}" method="post">
                                @csrf
                            <input type="submit" value="@lang('logout')">                                
                            </form>
                        @endauth
                    ...
                    <div class="box">
                        <div class="content">
                            <div id="gkIs-gk-is-156" class="gkIsWrapper-gk_black_and_white">
                                ...
                                <div class="gkIsPreloader">@lang('Loading')</div>

                                <div class="gkIsSlides" style="width: 950px;height: 350px;">

                                    @foreach (App\Slider::get() as $item)
                                        <span class="gkIsSlide">{{ asset('uploads/' . $item->image) }}</span>
                                    @endforeach
                    ...
                    <div id="gkRight" class="gkMain gkCol gkPaddingTBLR">
                        ...
                        <div id="gkRightMiddle" class="gkMain oneCol gkPaddingTBLR">
                            ...
                            <div id="gkRightRight" class="gkMain gkCol gkPaddingTBLR">
                                ...
                                <div class="box">
                                    <h3 class="header">@lang('last news')</h3>
                                    <div class="content">
                                        <div class="nspMain nspFs100" id="nsp-nsp_131" style="width:100%;">
                                            ...
                                            <div class="nspLinksWrap bottom " style="width:99.9%; ">
                                                <div class="nspLinks " style="margin:0; ">
                                                    <ul class="nspList ">
                                                        @foreach (App\News::get() as $key => $item)
                                                            <li
                                                                class="@if ($key % 2 == 0) even @else odd @endif">
                                                                <h4>
                                                                    <a style="color: black"
                                                                        href="{{ route('single_new', $item->id) }}"
                                                                        title="{{ $item->title }}">{{ $item->title }}</a>
                                                                </h4>
                                                                <span class="colornew"
                                                                    style="color: black">{!! $item->body !!}
                                                                </span>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                ...
                <form action="{{ route('stripe.get') }}" method="get">
                    <div class="form-group">
                        <input type="number" class="form-control" id="exampleInputEmail1" name="amount"
                            aria-describedby="emailHelp" placeholder="{{ __('amount') }}">
                    </div>
