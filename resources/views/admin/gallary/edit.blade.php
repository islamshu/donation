    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item active">@lang('Edit Gallery')</li>
        ...
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-8">
                <div class="card">
                    <div class="header">
                        <h2 style="display: inline">@lang('Edit Gallery')</h2>
                            ...
                            <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        ...
                                        @endif
                                        <form class="form-horizontal" method="post" action="{{ route('gallery.update',$gal->id) }}"
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input required type="text" value="{{ $gal->title }}"
                                            ...
                                            <div class="row clearfix testt ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" name="test[]" readonly value="{{ $item }}" id="images"
                                                                class="form-control">
                                                        </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-8 col-xs-7">
                                                    <img src="{{ asset('uploads/'.$item) }}" width="70" height="50" alt="">
