    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item active">@lang('edit news')</li>
        ...
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-8">
                <div class="card">
                    <div class="header">
                        <h2 style="display: inline">@lang('edit news')  </h2>
                            ...
                            <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="body">
                                        ...
                                        @endif
                                        <form class="form-horizontal" method="post" action="{{ route('news.update',$new->id) }}"
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input required type="text" value="{{ $new->title }}"
