                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                   @include('admin.partials._error')
                                    <form class="form-horizontal" method="post" action="{{ route('contests.store') }}">
                                        @csrf
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="text" value="{{ old('title_ar') }}" name="title_ar" id="title_ar" class="form-control"
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="text" value="{{ old('title_en') }}" name="title_en" id="title_en" class="form-control"
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="text" value="{{ old('prize') }}" name="prize" id="prize" class="form-control"
                                                            placeholder="الجائزة">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="datetime-local" value="{{ old('date_to_show') }}" name="date_to_show" id="date_to_show" class="form-control"
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input required type="datetime-local" value="{{ old('date_to_drow') }}" name="date_to_drow" id="date_to_drow" class="form-control"
                                        ...
                                        <div class="row clearfix" id="is_actitivty" style="display: none">
                                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-4 col-xs-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input  type="number" value="{{ old('lat') }}" name="lat" id="lat" class="form-control"
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-4 col-xs-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input  type="number" value="{{ old('long') }}" name="long" id="long" class="form-control"
                                        ...
                                        <div class="row clearfix" id="codecontest"  >
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input  type="number" value="{{ old('code') }}" required name="code" id="code" class="form-control"
                                                            placeholder="عدد المتسابقين">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="text" style="display: none" name="is_activity" value="0" id="testtt">
