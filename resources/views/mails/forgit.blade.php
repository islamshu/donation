					...
					<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
						<tr>
							<td colspan="4" valign="top" class="image-section" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;background-color: #fff;border-bottom: 4px solid #00a5b5">
								<a href="https://tenable.com"><img class="top-image" src="https://prize.wim-store.com/uploads/logo/IoJw2zkintXewSnTlRbKqSSNIsPD2WkYgEu3O4QX.png" style="line-height: 1;" width="200" height="150" alt="Tenable Network Security"></a>
							</td>
						</tr>
						<tr>
								...
								<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
									...
									<tr>
										...
										<div class="mktEditable" id="intro_title">
											لقد قمت مأخرا بطلب استرجاع كلمة المرور   <br>
									...
									<tr>
										...
										<img class="top-image" src="https://prize.wim-store.com/uploads/logo/IoJw2zkintXewSnTlRbKqSSNIsPD2WkYgEu3O4QX.png" width="500" height="300"/><br>
